...
клиент заходит на сайт и вводит невалидные данные карты (номер 4444 4444 4444 4442, срок действия 08.2027, ФИО Ivan Ivanovich Vetrov, CVC 999). Нажимает «Продолжить».
