...
клиент вводит не актуальные данные карты, средств на карте достаточно, но происходит отказ: покупатель заходит на сайт, вводит валидные данные карты (номер 4444 4444 4444 4442, срок действия 08.2027, ФИО Ivan Ivanovich Vetrov, CVC 999), остальные данные тоже валидные. Нажимает «Продолжить».
